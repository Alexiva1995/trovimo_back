...
Route::group(['prefix' => 'auth'], function () {
    ...
    Route::post('show-areas', 'Api\ExpertController@areas_company');
    Route::post('show-areas-populares', 'Api\ExpertController@areas_populares');
    ...
    Route::group(['middleware' => 'auth:api'], function () {
        ...
        Route::group(['prefix' => 'services'], function () {
            ...
            Route::post('search-shared-space', 'Api\Shared_SpacesController@search');
